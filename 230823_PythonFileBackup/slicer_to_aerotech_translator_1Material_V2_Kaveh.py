...
###################### IMPORT / EXPORT FILES ##############################################################################################################
import_gcode_txt = "NBrown_HexagonalPattern_V4.txt"       # upload gcode as txt file (i.e., must include .txt)
export_gcode_txt = "NBrown_HexagonalPattern_V4_aerotech.txt"    # export gcode as txt file (i.e., must include .txt)
