...
###################### IMPORT / EXPORT FILES ##############################################################################################################
import_gcode_txt = "SGresham_Cute_frog_micro.txt"             # upload gcode as txt file (i.e., must include .txt)
export_gcode_txt = "SGresham_Cute_frog_micro_aerotech.txt"    # export gcode as txt file (i.e., must include .txt)
