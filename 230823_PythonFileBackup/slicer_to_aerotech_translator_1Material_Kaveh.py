...
###################### IMPORT / EXPORT FILES ##############################################################################################################
import_gcode_txt = "Helical Gear_V7.2_ArcWelder.txt"       # upload gcode as txt file (i.e., must include .txt)
export_gcode_txt = "Helical Gear_V7.2_ArcWelder_aerotech.txt"    # export gcode as txt file (i.e., must include .txt)
